          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ElevatedButton(
                  onPressed: () =>
                      launchUrlString(profileViewModel.profile.discordLink),
                  child: const Text('Discord'),
                ),
                ElevatedButton(
                  onPressed: () =>
                      launchUrlString(profileViewModel.profile.githubLink),
                  child: const Text('GitHub'),
                ),
                ElevatedButton(
                  onPressed: () =>
                      launchUrlString(profileViewModel.profile.facebookLink),
